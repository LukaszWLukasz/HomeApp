...
namespace HomeApp
{
    public class FamilyMemberInFile : FamilyMemberBase
    {
        ...
        public FamilyMemberInFile(string name, string surname) :
            base(name, surname)
        {
            memberFileName = $"{name}_{surname}_{fileName}";
        }
        ...
        public override void AddPoint(double point)
        {
            ...
            {
                using (var writer = File.AppendText(memberFileName))
                {
